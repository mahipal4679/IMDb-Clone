...
//  API FUNCTION FOR LOADING MOVIES
...
function searchBoxTrigger() {
  if (movieSearchBox.value.length > 0) {
    ...
    movieSearchBox.style.borderBottomLeftRadius = '26px'
    searchBtn.style.borderBottomRightRadius = '26px'
  }
}
...
// THIS FUNCTION IS FOR DISPLAYING SUGGESTIONS FOR MOVIES WHEN WE TYPE SOME WORDS
...
function displayMovieList(movies) {
  ...
  for (let idx = 0; idx < movies.length; idx++) {
    ...
    //KNOW WE FETCHING THE API FOR SUGGESTIONS
...
function fav(data) {
  ...
  // console.log(data.parentNode.dataset.poster); MOST important....
  makeFavList(data.parentNode.dataset.poster)
}

let isEntering = false

// THIS FUNCTION IS FOR ADDING FAVOURITE 
...
// DISPLAYING MOVIES DETAILS AFTER ADDING MOVIES
...
// FUNCTION FOR RESET THE SEARCHBAR .
function resetBar() {
